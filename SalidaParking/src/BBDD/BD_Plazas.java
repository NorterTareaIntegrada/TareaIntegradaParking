...
public class BD_Plazas extends BBDD_Connector {
	...
	/**
	 * Función para sacar un coche del garaje, actualiza la plaza, y borra sus cargos
	 * @param pl Plaza objetivo
	 * @return Devuelve true si todo ha ido correctamente, false si ha ocurrido una excepción
	 */
	...
	/**
	 * Función para sacar un coche linkeado con una tarjeta de abonado del garaje, actualiza la plaza, y borra sus cargos
